...
const LandingLayouts = (props: LandingProps) => {
    ...
    return (
        <div className="flex justify-center h-screen items-center">
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-lg p-6 space-y-4  sm:max-w-lg md:max-w-md lg:max-w-md min-w-[300px] ml-[10px] mr-[20px]">
